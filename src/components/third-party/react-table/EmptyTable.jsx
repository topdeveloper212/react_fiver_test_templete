...
const StyledGridOverlay = styled(Stack)(({ theme }) => ({
  ...
  '& .ant-empty-img-1': {
    ...
    ...theme.applyStyles('dark', { fill: theme.palette.secondary[200] })
  },
  '& .ant-empty-img-2': {
  ...
  '& .ant-empty-img-3': {
    ...
    ...theme.applyStyles('dark', { fill: theme.palette.secondary.A200 })
  },
  '& .ant-empty-img-4': {
    fill: theme.palette.secondary.A100,
    ...theme.applyStyles('dark', { fill: theme.palette.secondary.A300 })
  },
  '& .ant-empty-img-5': {
    fillOpacity: 0.95,
    fill: theme.palette.secondary.light
